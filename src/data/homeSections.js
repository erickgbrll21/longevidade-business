export const homeSections = {
  model: {
    ...
    titleHtml: 'Nosso trabalho é <span class="grad-text-light">gratuito</span> para você.',
    paragraphs: [
  ...
  demanda: {
    ...
    titleHtml: 'Tem uma dor sem solução? <span class="grad-text">A gente constrói.</span>',
    description:
  ...
  ecossistema: {
    ...
    titleHtml: 'Não somos uma consultoria.<br>Somos um <span class="grad-text-light">ecossistema.</span>',
    description:
  ...
  mercadoPublico: {
    ...
    titleHtml: 'Seu negócio ainda não vende<br>para o governo. <span class="grad-text">Mas poderia.</span>',
    description:
  ...
  juridico: {
    ...
    titleHtml: 'Cada contrato, <span class="grad-text">juridicamente blindado.</span>',
    description:
  ...
  depoimentos: [
    ...
    },
    {
      ...
      name: 'Juliana Souza',
      role: 'Gerente Administrativa · Serviços',
      initials: 'JS',
    },
  ],
}
